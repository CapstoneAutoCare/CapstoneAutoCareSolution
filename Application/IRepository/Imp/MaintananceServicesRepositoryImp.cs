...
{
    public class MaintananceServicesRepositoryImp : GenericRepositoryImp<MaintenanceService>, IMaintenanceServiceRepository
    {
        public MaintananceServicesRepositoryImp(AppDBContext context) : base(context)
        {
        }
