...
namespace Application
{
    public partial class AppDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=db6574.public.databaseasp.net; Database=db6574; User Id=db6574; Password=yF%9!2EknT=8; Encrypt=True; TrustServerCertificate=True; MultipleActiveResultSets=True;");
